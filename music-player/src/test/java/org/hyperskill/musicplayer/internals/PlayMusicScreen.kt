...
class PlayMusicScreen(
    ...
    fun assertSongItem(errorMessage: String, itemView: View, song: SongFake) = with(test) {
        ...
        assertEquals(
            "$errorMessage Wrong text on $ID_SONG_ITEM_TV_ARTIST",
            song.artist,
            songItemTvArtist.text.toString()
        )
        assertEquals(
            "$errorMessage Wrong text $ID_SONG_ITEM_TV_TITLE",
            song.title,
            songItemTvTitle.text.toString()
        )
        assertEquals(
    ...
    fun assertControllerState(
        ...
        assertEquals(
            messageTotalTimeTv,
            songFake.duration.timeString(),
            controllerTvTotalTime.text.toString()
        )
        ...
        assertEquals(
            messageCurrentTimeTv,
            expectedPosition.timeString(),
            controllerTvCurrentTime.text.toString()
        )
    }
    ...
    private fun MediaPlayer.assertController(
        ...
        val messageCurrentPosition =
            "$errorMessage On mediaPlayer currentPosition expected: $expectedPosition found: $currentPosition"
