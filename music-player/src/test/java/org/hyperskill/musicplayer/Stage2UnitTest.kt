...
class Stage2UnitTest : MusicPlayerUnitTests<MainActivity>(MainActivity::class.java) {
    ...
    @Test
    fun test02_checkWhenCurrentTrackChangesAndOldCurrentTrackIsPlayingImageChangesToPaused() =
        testActivity {
            PlayMusicScreen(this).apply {
                mainButtonSearch.clickAndRun()
    ...
    @Test
    fun test03_checkWhenCurrentTrackChangesAndOldCurrentTrackIsNotPlayingImageRemains() =
        testActivity {
            PlayMusicScreen(this).apply {
                mainButtonSearch.clickAndRun()
                val songFakeIndexBefore = 5
    ...
    @Test
    fun test04_checkAfterInitialSearchFirstListItemIsCurrentTrackAndRespondToControllerPlayPauseButton() =
        testActivity {
            PlayMusicScreen(this).apply {
                mainButtonSearch.clickAndRun()
    ...
    @Test
    fun test05_checkCurrentTrackImgChangeAfterControllerStopButtonClickWithCurrentTrackPlaying() =
        testActivity {
            PlayMusicScreen(this).apply {
                val songFakeIndex = 4
                mainButtonSearch.clickAndRun()
    ...
    @Test
    fun test09_checkAddingPlaylistWithBothEmptyListAndEmptyPlaylistNameToastErrorEmptyListMessage() =
        testActivity {
            PlayMusicScreen(this).apply {
                mainButtonSearch
                mainSongList
    ...
    @Test
    fun test10_checkAddingPlaylistWithReservedPlaylistNameAllSongsToastErrorReservedNameMessage() =
        testActivity {
    ...
    @Test
    fun test11_checkLoadPlaylistInPlayMusicStateAfterAddingPlaylistWithMainMenuItem() =
        testActivity {
    ...
    fun test13_checkLoadPlaylistOnPlayMusicStateWithCurrentTrackKeepsCurrentTrack() = testActivity {
        ...
        PlayMusicScreen(this).apply {
            ...
            val caseDescription =
                "On PLAY_MUSIC state after adding a playlist with name $playlistName"
            mainSongList.assertListItems(
                songFakeList,
                caseDescription
            ) { itemViewSupplier, _, item ->
    ...
    fun test15_checkLoadPlaylistInAddPlaylistStateKeepsSelectedItemsById() {
        ...
        testActivity {
            ...
            AddPlaylistScreen(this).apply {
                ...
                val caseDescription =
                    "On ADD_PLAYLIST state after playlist $playlistName was added and $mainMenuItemIdAddPlaylist was clicked."
                mainSongList.assertListItems(
                    songFakeList,
                    caseDescription
                ) { itemViewSupplier, _, item ->
                ...
                val caseDescription2 =
                    "On ADD_PLAYLIST state after playlist $playlistName is loaded."
                mainSongList.assertListItems(
    ...
    @Test
    fun test16_checkLoadPlaylistInAddPlaylistStateKeepsCurrentTrackWhenReturningToPlayMusicState() =
        testActivity {
            ...
            PlayMusicScreen(this).apply {
                ...
                mainSongList.assertListItems(
                    songFakeList,
                    caseDescription
                ) { itemViewSupplier, position, song ->
                    assertSongItem(
                        caseDescription,
    ...
    @Test
    fun test17_checkPlaylistSavedAfterSelectingSongsAfterLoadingPlaylistInAddPlaylistState() =
        testActivity {
            ...
            AddPlaylistScreen(this).apply {
                val caseDescription =
                    "On ADD_PLAYLIST state after playlist $playlistName1 was added and $mainMenuItemIdAddPlaylist was clicked."
                mainSongList.assertListItems(
                    songFakeList,
                    caseDescription
                ) { itemViewSupplier, _, item ->
                ...
                val caseDescription2 =
                    "On ADD_PLAYLIST state after playlist $playlistName1 was loaded."
                mainSongList.assertListItems(
                    loadPlaylistOneSongs,
                    caseDescription2
                ) { itemViewSupplier, _, item ->
    ...
    fun test18_checkCancellingAddPlaylistKeepsCurrentPlaylist() = testActivity {
        ...
        PlayMusicScreen(this).apply {
            ...
            val caseDescription =
                "On PLAY_MUSIC state after playlist $playlistName is loaded and a new playlist addition was canceled."
            mainSongList.assertListItems(
                playlistSongFake,
                caseDescription
            ) { itemViewSupplier, _, item ->
    ...
    @Test
    fun test20_checkDeletePlaylistOnPlayMusicStateDeletingPlaylistThatIsNotCurrentPlaylist() =
        testActivity {
            val testedItemsZeroBasedIndexes = listOf(1, 3, 6)
            val playlistName = "My Playlist"
            PlayMusicScreen(this).apply {
    ...
    fun test21_checkDeletePlaylistOnPlayMusicStateWithCurrentPlaylistBeingDeleted() = testActivity {
        ...
        PlayMusicScreen(this).apply {
            ...
            //check items
            val caseDescription2 =
                "on PLAY_MUSIC state after deleting current playlist with name $playlistName"
            mainSongList.assertListItems(
                songFakeList,
                caseDescription2
            ) { itemViewSupplier, _, item ->
    ...
    @Test
    fun test23_checkDeletePlaylistOnAddPlaylistStateWithCurrentDisplayingAndCurrentPlaylistBeingDeleted() =
        testActivity {
            val testedItemsZeroBasedIndexes = listOf(1, 3, 6)
            val playlistName = "My Playlist"
            PlayMusicScreen(this).apply {
    ...
    fun test24_checkSearchInPlayMusicStateChangeCurrentPlaylistToAllSongs() = testActivity {
        ...
        PlayMusicScreen(this).apply {
            ...
            mainButtonSearch.clickAndRun()
            val caseDescription =
                "On PLAY_MUSIC state after clicking $ID_MAIN_BUTTON_SEARCH expected All Songs playlist to be loaded"
            mainSongList.assertListItems(
                songFakeList,
                caseDescription
            ) { itemViewSupplier, _, song ->
    ...
    @Test
    fun test25_checkSearchInAddPlaylistStateDisplaysAllSongsOnAddPlaylistStateAndKeepsCurrentPlaylistInPlayMusicState() =
        testActivity {
            val testedItemsZeroBasedIndexes = listOf(1, 3, 6)
            val playlistName = "My Playlist"
